        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    <div class="ltn__contact-address-item ltn__contact-address-item-3 box-shadow">
                        <div class="ltn__contact-address-icon">
                            <img src="{{asset('panel/img/icons/10.png')}}" alt="Icon Image">
                        </div>
                        <h3>Email Address</h3>
                ...
                <div class="col-lg-4">
                    <div class="ltn__contact-address-item ltn__contact-address-item-3 box-shadow">
                        <div class="ltn__contact-address-icon">
                            <img src="{{asset('panel/img/icons/11.png')}}" alt="Icon Image">
                        </div>
                        <h3>Phone Number</h3>
                ...
                <div class="col-lg-4">
                    <div class="ltn__contact-address-item ltn__contact-address-item-3 box-shadow">
                        <div class="ltn__contact-address-icon">
                            <img src="{{asset('panel/img/icons/12.png')}}" alt="Icon Image">
                        </div>
